...
angular.module('maktabAppApp')
  .controller('StudentsModalCtrl', ['$scope', '$http', '$stateParams','$location', '$filter','$modalInstance','item',/*'$mdDialog',*/'RegExp', function ($scope,$http, $stateParams, $location, $filter,$modalInstance,item,/*,$mdDialog,*/RegExp) {
    ...
    $scope.saveItem = function()
    {
        ...
        // if($scope.form.$valid)
          ...
          if($scope.courier._id){
            ...
            $http.put('/api/students/updateStudent/'+$scope.courier._id ,$scope.courier).then(function(response){
          ...
          {
            $http.post('/api/students',$scope.courier).then(function(response){
            $scope.courier={};
            $modalInstance.close('cancel');
